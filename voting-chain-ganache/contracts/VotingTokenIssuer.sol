    ...
    contract VotingTokenIssuer {
        ...
        // Keep as public so your backend can reuse token like before
        ...
        // ------------------------
        // Token issue/validate (same as your logic)
        // ------------------------
        ...
        // ------------------------
        // PRIVATE VOTE (no voter mapping stored)
        // Backend (owner) submits tx so blockchain does NOT show voter wallet.
        // ------------------------
            ...
            onlyOwner
        {
            ...
            // privacy: emit only candidateId (no voter info)
